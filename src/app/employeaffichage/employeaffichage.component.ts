...
@Component({
  selector: 'app-employeaffichage',
  templateUrl: './employeaffichage.component.html',
  styleUrls: ['./employeaffichage.component.scss']
})
export class EmployeaffichageComponent implements OnInit {
